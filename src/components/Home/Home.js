        ...
        return (
            <div className='home scroller'>
                <section className='about'>
                    ...
                    <Button className='resume-btn' variant='contained' href="/assets/Brittany_Chiu_Resume_050726.pdf" target="_blank" rel="noreferrer" download>Download Resume</Button>
                </section>
